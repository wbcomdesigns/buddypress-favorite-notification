		...
		<div class="bpfn-notification-content">
			...
			<?php if ( ! empty( $data['timestamp'] ) ) : ?>
				<div class="bpfn-notification-meta">
					<time datetime="<?php echo esc_attr( date( 'c', $data['timestamp'] ) ); ?>">
						<?php echo esc_html( human_time_diff( $data['timestamp'], current_time( 'timestamp' ) ) . ' ' . __( 'ago', 'bp-fav-notification' ) ); ?>
					</time>
				</div>
			<?php endif; ?>
...
function bpfn_notification_icon( $type = 'favorite' ) {
	$icons = apply_filters( 'bpfn_notification_icons', array(
