	...
	<div class="bpfn-enhanced-notification <?php echo $is_unread ? 'unread' : ''; ?>" 
		...
		<div class="bpfn-enhanced-content">
			<div class="bpfn-enhanced-header">
				...
				<?php if ( $time_ago ) : ?>
					<span class="bpfn-enhanced-time">
						<?php echo esc_html( sprintf( __( '%s ago', 'bp-fav-notification' ), $time_ago ) ); ?>
					</span>
				<?php endif; ?>
			</div>
			...
			<div class="bpfn-enhanced-actions">
				...
				<?php if ( ! empty( $user_link ) && $user_link !== bp_loggedin_user_domain() ) : ?>
					<a href="<?php echo esc_url( $user_link ); ?>" class="bpfn-enhanced-action secondary">
						<i class="dashicons dashicons-admin-users"></i>
						<?php _e( 'View Profile', 'bp-fav-notification' ); ?>
					</a>
				<?php endif; ?>
			</div>
		</div>
		...
		<div class="bpfn-quick-actions">
			<span class="bpfn-quick-action bpfn-mark-read" title="<?php esc_attr_e( 'Mark as read', 'bp-fav-notification' ); ?>">
			...
			<div class="bpfn-notification-body">
				...
				<?php if ( $time_ago ) : ?>
					<div class="bpfn-notification-meta">
						<time datetime="<?php echo esc_attr( date( 'c', $timestamp ) ); ?>">
							<?php echo esc_html( sprintf( __( '%s ago', 'bp-fav-notification' ), $time_ago ) ); ?>
						</time>
					</div>
				<?php endif; ?>
